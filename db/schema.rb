...
ActiveRecord::Schema.define(version: 20160526052945) do
  ...
  create_table "experts_tags", force: :cascade do |t|
    t.integer  "expert_id"
    t.integer  "tag_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "fake_comments", force: :cascade do |t|
    t.integer  "user_id"
    t.string   "name"
    t.text     "review"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "auth_token"
    t.boolean  "agreed_to_policies"
    t.boolean  "use_fake_rating"
    t.integer  "fake_rating"
    t.boolean  "use_fake_comments"
  end
